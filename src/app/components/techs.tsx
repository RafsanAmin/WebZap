    ...
    <div className="cont flex flex-col gap-3">
      ...
      <div className="flex flex-wrap gap-2 place-content-center">
        {[...Array(19).keys()].map((arr, index) => (
          <div
            key={index}
            className="w-[30%] aspect-square max-w-[100px] max-h-[100px] grid place-items-center  border border-slate-400 p-2 rounded-lg text-lg bg-[#ffffff1e]  transition-all duration-150  gap-8"
          >
            <img
